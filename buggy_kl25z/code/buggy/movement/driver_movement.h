 ...
 **********************************************************************************************************************/
#define V_START 		1500
#define V_TARGET 		1200
#define V_TURN			600 //600

#define DIFF_LIMIT_PERCENT_SPEED_DROITE     0.45	//40
#define DIFF_LIMIT_PERCENT_SPEED			0.45	//40
#define MOVEMENT_DIFF_GAIN_STRAIGHT 		0.0		// 0.0037	// Distance between 2 wheels E=15cm
#define MOVEMENT_DIFF_GAIN_TURN 			0.015      //0.012
#define MOVEMENT_DIFF_GAIN_TURN_DROITE	    0.015     // 0.012
