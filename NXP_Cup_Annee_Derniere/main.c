...
int servo_position_old = 0;					// old servo position
...
int main(void){
	...
	TPM1_C0V = 8200;				// TPM1 channel0 Servo 1 ca. 1.5 ms (middle)
...
void FTM1_IRQHandler()				// TPM1 ISR
{
	...
	TPM1_C0V  = 8200 - servo_position ; 		// set channel 0 PWM_Servo
		
	// Set Motor Speed
	TPM0_C1V = 25;					// TPM0 channel1 left Motor 1 In 1 slow forward
	TPM0_C5V = 25;					// TPM0 channel5 right Motor 2 In 2 slow forward
