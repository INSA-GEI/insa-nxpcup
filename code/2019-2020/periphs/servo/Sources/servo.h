...
#define  SERVO_CENTER_POS 9000		// initial servo position (center)
#define SERVO_HARD_LEFT 6000
#define SERVO_HARD_RIGHT 12000

#define SERVO_MAX_LEFT_ANGLE -45.0
#define SERVO_MAX_RIGHT_ANGLE 45.0
