...
C_DEPS += \
./rpmsg_lite/virtio/virtqueue.d 

OBJS += \
./rpmsg_lite/virtio/virtqueue.o 


# Each subdirectory must supply rules for building sources it contributes
rpmsg_lite/virtio/%.o: ../rpmsg_lite/virtio/%.c rpmsg_lite/virtio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-rpmsg_lite-2f-virtio

clean-rpmsg_lite-2f-virtio:
	-$(RM) ./rpmsg_lite/virtio/virtqueue.d ./rpmsg_lite/virtio/virtqueue.o

.PHONY: clean-rpmsg_lite-2f-virtio
