...
C_SRCS += \
../rpmsg_lite/common/llist.c 

C_DEPS += \
./rpmsg_lite/common/llist.d 

OBJS += \
./rpmsg_lite/common/llist.o 


# Each subdirectory must supply rules for building sources it contributes
rpmsg_lite/common/%.o: ../rpmsg_lite/common/%.c rpmsg_lite/common/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-rpmsg_lite-2f-common

clean-rpmsg_lite-2f-common:
	-$(RM) ./rpmsg_lite/common/llist.d ./rpmsg_lite/common/llist.o

.PHONY: clean-rpmsg_lite-2f-common
