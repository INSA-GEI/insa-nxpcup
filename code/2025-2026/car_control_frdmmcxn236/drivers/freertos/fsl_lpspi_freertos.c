...
#define FSL_COMPONENT_ID "platform.drivers.lpflexcomm_lpspi_freertos"
#endif
                         ...
                         uint32_t srcClock_Hz)
{
    ...
    (void)LPSPI_MasterInit(handle->base, masterConfig, srcClock_Hz);
