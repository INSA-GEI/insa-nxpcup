...
#define LCDFXIOPINS_LCD_CS_INIT_GPIO_VALUE 0U        /*!<@brief GPIO output initial state */
...
#define LCDFXIOPINS_LCD_RS_INIT_GPIO_VALUE 0U        /*!<@brief GPIO output initial state */
...
#define LCDFXIOPINS_LCD_RST_INIT_GPIO_VALUE 0U       /*!<@brief GPIO output initial state */
...
#define SMARTDMACAMERAPINS_CAM_PDWN_INIT_GPIO_VALUE 0U        /*!<@brief GPIO output initial state */
...
#define SMARTDMACAMERAPINS_CAM_RST_INIT_GPIO_VALUE 1U        /*!<@brief GPIO output initial state */
