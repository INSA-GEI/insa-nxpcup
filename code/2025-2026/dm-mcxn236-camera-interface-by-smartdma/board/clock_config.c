...
void BOARD_BootClockPLL150M(void)
{
    ...
    /*!< Set up CLKOUT Fractional Rate Generator */
    SYSCON->CLKOUT_FRGCTRL = ((SYSCON->CLKOUT_FRGCTRL & ~SYSCON_CLKOUT_FRGCTRL_MULT_MASK) | SYSCON_CLKOUT_FRGCTRL_MULT(0U)); /*!< Set FRG MULT to value 0 */
