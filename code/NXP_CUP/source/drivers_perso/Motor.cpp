...
//	TPM0->C5SC = 0x28;				// CH5 (left motor)
	tpmParam[1].chnlNumber = (tpm_chnl_t)kTPM_Chnl_5;
	tpmParam[1].level = kTPM_LowTrue;
	tpmParam[1].dutyCyclePercent = 50U;

	TPM_SetupPwm(TPM0, tpmParam, sizeof(tpmParam), kTPM_EdgeAlignedPwm, F_PWM_motor, CLOCK_GetFreq(kCLOCK_CoreSysClk)/TPM0_PS);
	...
	// TODO : A revoir les valeurs qu'on met
	MOTOR_LEFT_FSPEED(50);
