...
#define DEBUG_RED_OFF		(GPIOB->PSOR = DEBUG_RED_Pin)
#define DEBUG_RED_ON		(GPIOB->PCOR = DEBUG_RED_Pin)
#define DEBUG_GREEN_OFF		(GPIOB->PSOR = DEBUG_GREEN_Pin)
#define DEBUG_GREEN_ON		(GPIOB->PCOR = DEBUG_GREEN_Pin)
#define DEBUG_BLUE_OFF		(GPIOD->PSOR = DEBUG_BLUE_Pin)
#define DEBUG_BLUE_ON		(GPIOD->PCOR = DEBUG_BLUE_Pin)
#define DEBUG_CAM_LED_ON    (GPIOC->PSOR = DEBUG_CAM_LED_Pin)
#define DEBUG_CAM_LED_OFF   (GPIOC->PCOR = DEBUG_CAM_LED_Pin)

#define DISP_CLK_PIN		(1<<5)
#define DISP_SIN_PIN 		(1<<6)
#define DISP_LATCH_PIN 		(1<<10)

#define DISP_CLK_OFF		(GPIOC->PCOR = DISP_CLK_PIN)
#define DISP_CLK_ON			(GPIOC->PSOR = DISP_CLK_PIN)
#define DISP_SIN_OFF		(GPIOC->PCOR = DISP_SIN_PIN)
#define DISP_SIN_ON			(GPIOC->PSOR = DISP_SIN_PIN)
#define DISP_LATCH_OFF		(GPIOC->PCOR = DISP_LATCH_PIN)
#define DISP_LATCH_ON		(GPIOC->PSOR = DISP_LATCH_PIN)
