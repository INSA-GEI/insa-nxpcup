...
//	PIOB_PDOR &= ~GPIO_PDOR_PDO(1<<18);  // red LED on
	...
	test_image_processing(&BlackLineLeft, &BlackLineRight, edges, &number_edges, edges_final);	// image processing : finds the black lines on the left and right, and finds the middle of the track
